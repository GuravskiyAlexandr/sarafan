...
public class MessageService {
    ...
    private void fullMete(Message message) throws IOException {
    ...
    private MetaDto getMetaDto(String url) {
        Document doc = null;
        try {
 ...
 //       BeanUtils.copyProperties(message, messageFromDb, "id", "comments");
    ...
    public MessagePageDto findForUser(Pageable pageable, User user) {
        List<User> chanels = userSubscriptionRepo.findBySubscriber(user)
                .stream()
        ...
        chanels.add(user);
        Page<Message> page = messageRepo.findByAuthorIn(chanels, pageable);
