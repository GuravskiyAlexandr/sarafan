...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        updateTotalPageMutation(state, totalPage) {
    ...
    actions: {
        async addMessageAction({commit, state}, message) {
            ...
            console.log(index)
            if (index > -1) {
                console.log('updateMessageMutation')
                commit('updateMessageMutation', data)
            } else {
                console.log('addMessageMutation')
        ...
        async updateMessageAction({commit}, message) {
            ...
            const data = await result.json()
            commit('updateMessageMutation', data)
            console.log(' async updateMessageAction')
        ...
        async loadPageAction({commit, state}){
            ...
            commit('updateTotalPageMutation', data.totalPage)
            commit('updateCurrentPageMutation', Math.min(data.currentPage, data.totalPage - 1))
        }
